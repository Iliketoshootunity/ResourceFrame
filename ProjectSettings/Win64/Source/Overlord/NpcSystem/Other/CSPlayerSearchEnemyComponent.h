...
class OVERLORD_API UCSPlayerSearchEnemyComponent : public UCSSearchEnemyComponent
{
	GENERATED_BODY()
protected:
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SearchEnemyParameter)
	float LockRange = 500;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SearchEnemyParameter)
	float FirsetLock = 500;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SearchEnemyParameter)
	float HasRockerAngleLimit = 60;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SearchEnemyParameter)
	float NoRockerAngleLimit = 60;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SearchEnemyParameter)
	float MaxRotateAngle = 60;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SearchEnemyParameter)
	FVector2D RockerInput= FVector2D::ZeroVector;
