...
inline ::PROTOBUF_NAMESPACE_ID::int32 HurtTarget::x() const {
  // @@protoc_insertion_point(field_get:fightV2.HurtTarget.x)
  return x_;
}
inline void HurtTarget::set_x(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _has_bits_[0] |= 0x00000200u;
  x_ = value;
...
inline ::PROTOBUF_NAMESPACE_ID::int32 HurtTarget::y() const {
  // @@protoc_insertion_point(field_get:fightV2.HurtTarget.y)
  return y_;
}
inline void HurtTarget::set_y(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _has_bits_[0] |= 0x00000400u;
  y_ = value;
...
// optional int64 roleId = 1;
inline bool ComboEnd::has_roleid() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void ComboEnd::clear_roleid() {
  roleid_ = PROTOBUF_LONGLONG(0);
  _has_bits_[0] &= ~0x00000001u;
}
inline ::PROTOBUF_NAMESPACE_ID::int64 ComboEnd::roleid() const {
  // @@protoc_insertion_point(field_get:fightV2.ComboEnd.roleId)
  return roleid_;
}
inline void ComboEnd::set_roleid(::PROTOBUF_NAMESPACE_ID::int64 value) {
  _has_bits_[0] |= 0x00000001u;
  roleid_ = value;
  // @@protoc_insertion_point(field_set:fightV2.ComboEnd.roleId)
}
